...
public final class NovaBiomeMaker
{
	...
	public static Biome forestBiome(float depth, float scale, boolean tallTrees)
	{
		...
		// if (tallTrees) {
		// DefaultBiomeFeatures.addTallBirchTrees(genSettings);
		// } else {
		genSettings.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, NovaFeatures.ConfiguredFeatures.TREES_WHITE_OAK);
		// }
	...
	public static final Biome createForest()
	{
		Biome.Builder bb = new Biome.Builder();
